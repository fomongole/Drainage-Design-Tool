...
export function SessionList() {
  ...
  // MOBILE UX: Collapse by default on screens smaller than 1024px
  useEffect(() => {
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      ...
      setSessionName('')
      setIsSaving(false)
      // Auto-expand list if they just saved a new session
      setIsExpanded(true)
    }, 120)
  }
  ...
  return (
    <Card title="Saved Sessions" subtitle={subtitle}>
      ...
      <div className="lg:hidden mb-4">
        ...
        >
          <span>{isExpanded ? 'Hide saved sessions' : 'Show saved sessions'}</span>
